...
ggplot(df_expected_glm, aes(x = Education, y = Average)) +
  ...
  geom_errorbar(aes(ymax = Upper.Bound, ymin = Lower.Bound))+
  scale_x_continuous(name = "Education", breaks=seq(0,17,1)) +
  labs(y = "Confidence Intervals for Expected Probability of Receiving Treatment", title = "Expected Probabilities of Receiving Treatment Using Logistic Regression")
